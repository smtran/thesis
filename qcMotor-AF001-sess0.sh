...
#
sourceParentDir=/data/birc/Florida/AEROBIC_FITNESS/SUBJECTS/AF_s01/AF_s01/acqfiles
...
for seriesNumber in ${fmriSeriesList}; do
      ...
      echo -n "FILE COUNT: "
      ls -1 ${sourceParentDir}/${seriesNumber}/fmri*.nii | wc -l
      ...
      echo ""
      analyze2bxh ${sourceParentDir}/${seriesNumber}/fmri*.nii ${tempDir}/fmriSeries${seriesNumber}.bxh
      echo ""
      echo "...done."
      echo ""
