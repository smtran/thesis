...
for seriesNumber in ${seriesList}; do
      ...
      echo ""
      analyze2bxh ${sourceParentDir}/${seriesNumber}/DBIEX*.nii ${tempDir}/series-${seriesNumber}.bxh
      echo ""
      echo "...done."
      echo ""
      echo "Creating new nifti volume for series ${seriesNumber}..."
      echo ""
      bxh2analyze --nii -b -s ${tempDir}/series-${seriesNumber}.bxh ${tempDir}/series-${seriesNumber}
      echo ""
      echo "...done."
      echo ""
      echo "Reorienting series ${seriesNumber} nifti volume to match FSL's MNI 152 template..."
      echo ""
      fslreorient2std ${tempDir}/series-${seriesNumber}.nii ${tempDir}/series-${seriesNumber}_MNI
      echo ""
      echo "...done."
      echo ""
done
